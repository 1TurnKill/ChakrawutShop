    ...
    return (
        <>
            ...
            <div>
                ...
                width="500" height="500" loading="lazy" frameBorder="0" ></iframe><br/><br/> 
            </div>

            <div>
                <p className= "fontเกี่ยวกับเรา">เกี่ยวกับเรา</p>
                <br/>
                ...
                <div className= "fontหัวข้อรอง">ที่อยู่ร้าน</div>
                ...
                *** ร้านค้าอยู่ติดถนนใหญ่ ก่อนถึงโลตัสกับบิ๊กซีค่ะ *** <br/><br/>  
                ...
                <div className= "fontหัวข้อรอง">Line</div>
                <img src="Line_Ya.jpg" sizes="(max-width: 479px) 92vw, 99px" width="200" alt="" className="footer-image" />
                ID line : 0894586469<br/><br/> 

                <div className= "fontหัวข้อรอง">Facebook</div>
                Page : ส.จักราวุธ จักรเย็บผ้า อะไหล่จักร<br/>
                Link : <a href ="shorturl.at/wxDIY">Facebook ส.จักราวุธ</a><br/><br/> 

                <div className= "fontหัวข้อรอง">Shopee</div>
                Shop : ChakrawutShop<br/>
                Link : <a href ="https://shopee.co.th/chakrawutshop">Shopee ChakrawutShop</a><br/><br/> 

                <div className= "fontหัวข้อรอง">Phone</div>
                Phone : 091-941-4289<br/><br/> 

                <div className= "fontหัวข้อรอง">Email</div>
